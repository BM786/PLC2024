...
adsFromPlaylists playlists = [advert | playlist <- playlists, item <- playlist, advert <- getAdvert item] -- TASK 6.4(b)

shortItemLengths1 = [lengthSecs | item <- playlist1, let lengthSecs = length_secs item, lengthSecs < 20.0] -- TASK 6.4(a)
